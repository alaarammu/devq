...
// import { getQuestionsByTagNameAndCompany } from '../../../../services/tagServices/tagService';

// export default function CollectionQuestions() {
...
//         switch (activeButton) {
//             case 'all':
//                 return `All Questions in ${tagName}`;
//             case 'new':
...
//         const result = await getQuestionsByTagNameAndCompany(companyId, tagName);
...
export default function CollectionQuestions() {
    ...
    useEffect(() => {
        getCompanyQuestion();
    }, [tagName]); // Ensure tagName is included as a dependency
